...
plt.savefig('logs_MH_subset/figures/TabNet_pre1_train1_test1_nonpc2pc_prec_recall_curve_over13.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_pre1_train1_test1_nonpc2pc_ROC_curve_over13.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_pre1_train1_test1_nonpc2pc_over13')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_pre1_train1_test1_nonpc2pc_over13.csv')
