...
# ### Optimizing TabNet using Optuna
print('------------------------------------------')
print()
print('Now using Optuna!!!')

print('Training TabNet, optimizing with Optuna, weights=1, Train PC, Test PC')
print()
...
# ### Wegiths 1
print()
print('Training TabNet, with optimized Optuna params, weights=1, Train PC, Test PC')
print()
...
print('Results TabNet, with optimized Optuna params, weights=1, Train PC, Test PC')
...
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_pc2pc_prec_recall_curve.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_pc2pc_ROC_curve.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_train1_test1_pc2pc')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_train1_test1_pc2pc.csv')
...
# optional training without weight balancing (=0)
# # ### Weights 0
#
# print('Training TabNet, with optimized Optuna params, weights=0, Train PC, Test PC')
# print("weights=0")
# print()
#
#
...
# print()
#
# print('Results TabNet, with optimized Optuna params, weights=0, Train PC, Test PC')
# acc_val = accuracy_score(y_val, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val.values)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val)
...
# print("Preicision score is: ", metrics.precision_score(y_test, preds))
# print("Recall score is: ", metrics.recall_score(y_test, preds))
# print(metrics.classification_report(y_test, preds))
# print(metrics.confusion_matrix(y_test, preds))
# tn, fp, fn, tp = metrics.confusion_matrix(y_test, preds).ravel()
# specificity = tn / (tn+fp)
...
# ### Trained on Primary Care Data Testing with Non Primary Care Data
print()
print('------------')
print()

print('Trained on Primary Care Data Testing with Non Primary Care Data')
print()
...
preds_non_pc = clf.predict(X_test_non_pc.values)

history = clf.history
print(history)
acc_val_non_pc = accuracy_score(y_val_non_pc, preds_val) * 100
print("Validation Accuracy for Optuna Tuned Model: ", acc_val_non_pc)
preds_val= clf.predict_proba(X_val_non_pc.values)
val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc)
print("Validation AUC for Optuna Tuned Model: ", val_auc)

acc_non_pc = accuracy_score(y_test_non_pc, preds_non_pc) * 100
print("Test Accuracy for Optuna Tuned Model: ", acc_non_pc)
...
f1 = metrics.f1_score(y_test_non_pc, preds_non_pc)
print("F1 score is: ", f1)

precision = metrics.precision_score(y_test_non_pc, preds_non_pc)
print("Preicision score is: ", precision)

recall = metrics.recall_score(y_test_non_pc, preds_non_pc)
print("Recall score is: ", recall)

print(metrics.classification_report(y_test_non_pc, preds_non_pc))
print(metrics.confusion_matrix(y_test_non_pc, preds_non_pc))

tn, fp, fn, tp = metrics.confusion_matrix(y_test_non_pc, preds_non_pc).ravel()
specificity = tn / (tn+fp)
print("Specificity score is: ", specificity)
sensitivity = tp / (tp+fn)
print("Sensitivity score is: ", sensitivity)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_pc2nonpc_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_pc2nonpc_ROC_curve.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
# joblib.dump(clf, 'logs_MH_subset/saved_models/TabNet_train1_test1_pc2nonpc.pkl')
clf.save_model('logs_MH_subset/saved_models/TabNet_train1_test1_pc2nonpc')
print("model saved")
print()
...
df_pc['Predicted_probs_test'] = pd.Series(preds_test[:,1])
df_pc['Pred_y_test'] = pd.Series(preds_non_pc)
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_train1_test1_pc2nonpc.csv')
print('metrics file saved')
print()
...
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val_non_pc)
# preds_val= clf.predict_proba(X_val_non_pc.values)
# val_auc = roc_auc_score(y_score=preds_va[:,1], y_true=y_val_non_pc)
# print("Validation AUC for Optuna Tuned Model: ", val_auc)
#
# acc_non_pc = accuracy_score(y_test_non_pc, preds_non_pc) * 100
# print("Test Accuracy for Optuna Tuned Model: ", acc_non_pc)
# preds_test= clf.predict_proba(X_test_non_pc.values)
# test_auc_non_pc = roc_auc_score(y_score=preds_test[:,1], y_true=y_test_non_pc)
# print("Test AUC for Optuna Tuned Model: ", test_auc_non_pc)
#
# print("ROC AUC is: ",metrics.roc_auc_score(y_test_non_pc, preds_test[:,1]))
# print("F1 score is: ", metrics.f1_score(y_test_non_pc, preds_non_pc))
# print("Preicision score is: ", metrics.precision_score(y_test_non_pc, preds_non_pc))
# print("Recall score is: ", metrics.recall_score(y_test_non_pc, preds_non_pc))
# print(metrics.classification_report(y_test_non_pc, preds_non_pc))
# print(metrics.confusion_matrix(y_test_non_pc, preds_non_pc))
# tn, fp, fn, tp = metrics.confusion_matrix(y_test_non_pc, preds_non_pc).ravel()
# specificity = tn / (tn+fp)
