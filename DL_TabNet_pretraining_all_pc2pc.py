...
# drop empty cols to fix and replace
...
study.optimize(objective_pretrain, n_trials=100) # 100
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_train1_test1_pc2pc_prec_recall_curve_over13.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_train1_test1_pc2pc_ROC_curve_over13.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_pre2_train1_test1_pc2pc_over13')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_pre2_train1_test1_pc2pc_over13.csv')
