...
print('Training TabNet, optimizing with Optuna for PC, weights=1')
print()
...
print()
print('Training TabNet, with optimized Optuna params for PC, weights=1')
...
print('Results TabNet on PC, optimizing with Optuna for PC, weights=1')
...
print("Validation ROC AUC is: ",roc_auc_score(y_score=preds_val[:,1], y_true=y_val_pc))
print("Validation F1 score is: ", metrics.f1_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc.values)))
print("Validation Precision score is: ", metrics.precision_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc.values)))
print("Validation Recall score is: ", metrics.recall_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc.values)))
print(metrics.classification_report(y_true = y_val_pc, y_pred = clf.predict(X_val_pc.values)))
print(metrics.confusion_matrix(y_true = y_val_pc, y_pred = clf.predict(X_val_pc.values)))
...
plt.savefig('logs_MH_subset/figures/TabNet_entire_data_testPC_prec_recall_curve.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_entire_data_testPC_ROC_curve.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_entire_data_testPC')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_entire_data_testPC.csv')
...
# # ### Weights 0
#
# print('Training TabNet, with optimized Optuna params for PC, weights=0')
#
# # In[49]:
# clf.fit(
...
# print()
#
# print('Results TabNet on PC, optimizing with Optuna for PC, weights=0')
# acc_val = accuracy_score(y_val_pc, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val_pc.values)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_pc)
...
# print("Precision score is: ", metrics.precision_score(y_test_pc, preds))
...
print('Now dealing with Non PC data (testing and validating on non PC data)')
print()

# ## Optuna for TabNet and Non PC

print('Training TabNet, optimizing with Optuna for Non PC, weights=1')
print()
...
def objective(trial):
    ...
    try:
        ...
        if "index -1 is out of bounds" in str(e):
            print(f"Skipping trial {trial.number} due to sparsemax failure.")
            raise optuna.TrialPruned()  # Skip this trial without stopping optimization
        else:
            raise
...
# ### Wegiths 1
print()
print('Training TabNet, with optimized Optuna params for Non PC, weights=1')
...
print('Results TabNet on Non PC, optimizing with Optuna for Non PC, weights=1')
...
print("Validation ROC AUC is: ",roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc))
print("Validation F1 score is: ", metrics.f1_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc.values)))
print("Validation Precision score is: ", metrics.precision_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc.values)))
print("Validation Recall score is: ", metrics.recall_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc.values)))
print(metrics.classification_report(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc.values)))
print(metrics.confusion_matrix(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc.values)))
...
print("Preicision score is: ", precision)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/TabNet_entire_data_testNonPC_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/TabNet_entire_data_testNonPC_ROC_curve.png')
print('saved roc-auc curve')
print()
...
clf.save_model('logs_MH_subset/saved_models/TabNet_entire_data_testNonPC')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_entire_data_testNonPC.csv')
print('metrics file saved')
print()
...
# # ## Weights 0
# print('Training TabNet, with optimized Optuna params for Non PC, weights=0')
#
# # In[41]:
# clf.fit(
#       X_train.values, y_train,weights=0,
...
# print()
#
# print('Results TabNet on Non PC, optimizing with Optuna for Non PC, weights=0')
# acc_val = accuracy_score(y_val_non_pc, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val_non_pc.values)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc)
...
print('Training Random Forest Classifier, optimizing with optuna on PC')
print()
...
def objective(trial):
    ...
    max_features = trial.suggest_categorical("max_features", ['sqrt', 'log2'])  # NICK: removed 'auto' 3/4/24
    ...
    preds_valid = clf.predict_proba(X_val_pc)
    valid_auc = roc_auc_score(y_score=preds_valid[:, 1], y_true=y_val_pc)
...
print()
print('Training Random Forest Classifier balanced class weight, with optuna params optimized on PC')
clf = RandomForestClassifier(**study.best_params, class_weight="balanced")
clf.fit(X_train, y_train)
preds_val = clf.predict(X_val_pc)
preds = clf.predict(X_test_pc)

print('Results Random Forest Classifier balanced class weight, with optuna params optimized on PC')
acc_val = accuracy_score(y_val_pc, preds_val) * 100
print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
preds_val= clf.predict_proba(X_val_pc)
val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_pc)
print("Validation AUC for Optuna Tuned Model: ", val_auc)

print("Validation ROC AUC is: ",roc_auc_score(y_score=preds_val[:,1], y_true=y_val_pc))
print("Validation F1 score is: ", metrics.f1_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc)))
print("Validation Precision score is: ", metrics.precision_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc)))
print("Validation Recall score is: ", metrics.recall_score(y_true = y_val_pc, y_pred = clf.predict(X_val_pc)))
print(metrics.classification_report(y_true = y_val_pc, y_pred = clf.predict(X_val_pc)))
print(metrics.confusion_matrix(y_true = y_val_pc, y_pred = clf.predict(X_val_pc)))

acc = accuracy_score(y_test_pc, preds) * 100
print("Test Accuracy for Optuna Tuned Model: ", acc)
preds_test= clf.predict_proba(X_test_pc)
test_auc = roc_auc_score(y_score=preds_test[:,1], y_true=y_test_pc)
print("Test AUC for Optuna Tuned Model: ", test_auc)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/RF_entire_data_testPC_prec_recall_curve_over13.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/RF_entire_data_testPC_ROC_curve_over13.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_entire_data_testPC_over13.pkl')
# clf.save_model('logs_MH_subset/saved_models/RF_entire_data_testPC')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_entire_data_testPC_over13.csv')
print('metrics file saved')
print()


# # In[44]:
# print('Training Random Forest Classifier NOT balanced class weight, with optuna params optimized on PC')
# clf = RandomForestClassifier(**study.best_params)
# clf.fit(X_train, y_train)
# preds_val = clf.predict(X_val_pc)
# preds = clf.predict(X_test_pc)
#
# print('Results Random Forest Classifier NOT balanced class weight, with optuna params optimized on PC')
# acc_val = accuracy_score(y_val_pc, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val_pc)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_pc)
...
# # Random Forest Optuna Non PC

print('Training Random Forest Classifier, optimizing with optuna on Non PC')
print()
...
def objective(trial):
    ...
    preds_valid = clf.predict_proba(X_val_non_pc)
    valid_auc = roc_auc_score(y_score=preds_valid[:, 1], y_true=y_val_non_pc)
...
print()
print('Training Random Forest Classifier balanced class weight, with optuna params optimized on Non PC')
clf = RandomForestClassifier(**study.best_params, class_weight="balanced")
clf.fit(X_train, y_train)
preds_val = clf.predict(X_val_non_pc)
preds = clf.predict(X_test_non_pc)

print('Results Random Forest Classifier balanced class weight, with optuna params optimized on Non PC')
acc_val = accuracy_score(y_val_non_pc, preds_val) * 100
print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
preds_val= clf.predict_proba(X_val_non_pc)
val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc)
print("Validation AUC for Optuna Tuned Model: ", val_auc)

print("Validation ROC AUC is: ",roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc))
print("Validation F1 score is: ", metrics.f1_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc)))
print("Validation Precision score is: ", metrics.precision_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc)))
print("Validation Recall score is: ", metrics.recall_score(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc)))
print(metrics.classification_report(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc)))
print(metrics.confusion_matrix(y_true = y_val_non_pc, y_pred = clf.predict(X_val_non_pc)))

acc = accuracy_score(y_test_non_pc, preds) * 100
print("Test Accuracy for Optuna Tuned Model: ", acc)
preds_test= clf.predict_proba(X_test_non_pc)
test_auc = roc_auc_score(y_score=preds_test[:,1], y_true=y_test_non_pc)
print("Test AUC for Optuna Tuned Model: ", test_auc)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/RF_entire_data_testNonPC_prec_recall_curve_over13.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/RF_entire_data_testNonPC_ROC_curve_over13.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_entire_data_testNonPC_over13.pkl')
# clf.save_model('logs_MH_subset/saved_models/RF_entire_data_testNonPC')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_entire_data_testNonPC_over13.csv')
print('metrics file saved')
print()


# # In[49]:
# print('Training Random Forest Classifier NOT balanced class weight, with optuna params optimized on Non PC')
# clf = RandomForestClassifier(**study.best_params)
# clf.fit(X_train, y_train)
# preds_val = clf.predict(X_val_non_pc)
# preds = clf.predict(X_test_non_pc)
#
# print('Results Random Forest Classifier NOT balanced class weight, with optuna params optimized on Non PC')
# acc_val = accuracy_score(y_val_non_pc, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val_non_pc)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc)
