...
pc_data = mh_data # this is the mh data, just named pc_data variable name
...
# loop through all 320 columns, if name not in list of 94, drop it, else leave it
...
joblib.dump(clf, 'logs_MH_subset/saved_models/log_reg_94scratch_not_balanced_MH_correct.pkl')
print("model saved")
print()
