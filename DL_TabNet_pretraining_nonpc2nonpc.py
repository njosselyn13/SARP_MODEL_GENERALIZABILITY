...
plt.savefig('logs_MH_subset/figures/TabNet_pre1_train1_test1_nonpc2nonpc_prec_recall_curve.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_pre1_train1_test1_nonpc2nonpc_ROC_curve.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_pre1_train1_test1_nonpc2nonpc')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_pre1_train1_test1_nonpc2nonpc.csv')
