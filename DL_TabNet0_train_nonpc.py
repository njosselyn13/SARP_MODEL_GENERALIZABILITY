...
print()
print("1 TO 1: TabNet TRAIN ON NON PC, TEST ON PC OR NON PC")
print()

# read ata file, replace with filename here
# data1 = pd.read_csv('MHRN4_with_zip_income_college_binarized_new.csv')
data1 = pd.read_csv('combined_pc_mh_data.csv')

# filter data for only patients 13 and older
...
# drop excess columns not overlapping with MHRN study
...
# target variable, suicide attempt within 90 days 
data["event90"] = data["event90"].fillna(value=0)

# drop empty columns from dataset, to replace with correct
...
# drop or impute missing columns/values
for i in missing_columns:
...
# ### Optimizing TabNet using Optuna on Non-Primary care data


print()
print()
print("Optuna training!")

print()

print("Train Non PC, Test Non PC")
print()
print("tuned with weights = 1")
print()
...
def objective(trial):
    ...
    history = clf.history
    acc_non_pc = accuracy_score(y_test_non_pc, preds) * 100
...
print()
print("Train Non PC, Test Non PC, weights=1, using optuna best params")
print("weights=1")
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_nonpc2nonpc_prec_recall_curve.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_nonpc2nonpc_ROC_curve.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_train1_test1_nonpc2nonpc')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_train1_test1_nonpc2nonpc.csv')
print('metrics file saved')
print()
print()


# optional training with weight balacing off (=0)
# print("weights=0")
#
# print()
# print("Train Non PC, Test Non PC, weights=0, using optuna best params")
# print()
#
# best_params = study.best_params
# patience_op = best_params['patience']
...
# print('patience_op:', patience_op)
#
# clf = TabNetClassifier(scheduler_params=dict(mode="min",
#                                                patience=patience_op,
#                                                # changing sheduler patience to be lower than early stopping patience
#                                                min_lr=1e-5,
#                                                factor=0.5, ), **best_params)
#
# clf.fit(
#       X_train_non_pc.values, y_train_non_pc, weights=0,
#       eval_set=[(X_val_non_pc.values, y_val_non_pc)],
#                eval_metric=['auc'],
#                max_epochs = 100
#     )
...
# print("Precision score is: ", metrics.precision_score(y_test_non_pc, preds))
...
def objective(trial):
    ...
    history = clf.history
    acc_non_pc = accuracy_score(y_test, preds) * 100
...
print()
print("Train Non PC, Test PC, weights=1, using optuna best params")
print("weights=1")
print()
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_nonpc2pc_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/TabNet_train1_test1_nonpc2pc_ROC_curve.png')
print('saved roc-auc curve')
print()
...
clf.save_model('logs_MH_subset/saved_models/TabNet_train1_test1_nonpc2pc')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_train1_test1_nonpc2pc.csv')
print('metrics file saved')
print()
...
# optional training with weight balancing off (=0)
# print("weights=0")
#
# print()
# print("Train Non PC, Test PC, weights=0, using optuna best params")
# print()
#
# best_params = study.best_params
# patience_op = best_params['patience']
...
# print("Precision score is: ", metrics.precision_score(y_test, preds))
