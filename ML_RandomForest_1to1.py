...
# for i in missing_columns:
#     if sum(non_pc_data[i].isnull()) == non_pc_data.shape[0]: #446893:
#         # data[i].fillna(value=0,inplace=True)
...
print('Random Forest Hyperparameter Tuning using Optuna')
...
roc_auc = metrics.roc_auc_score(y_test, preds_test[:, 1])
print("ROC AUC is: ", roc_auc)

f1 = metrics.f1_score(y_true=y_test, y_pred=preds)
...
prec_test, recall_test, _ = metrics.precision_recall_curve(y_test, preds_test[:,1])
# Calculate AUC-PRC
auc_prc_test = metrics.auc(recall_test, prec_test)
print("TEST Precision-Recall AUC:", auc_prc_test)

prec_val, recall_val, _ = metrics.precision_recall_curve(y_val, preds_val[:,1])
# Calculate AUC-PRC
...
plt.savefig('logs_MH_subset/figures/RF_train1_test1_pc2pc_prec_recall_curve.png')
print()
print()

# ROC-AUC curve -- Test data
fpr_curve, tpr_curve, _ = metrics.roc_curve(y_test, preds_test[:,1])
...
plt.savefig('logs_MH_subset/figures/RF_train1_test1_pc2pc_ROC_curve.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_train1_test1_pc2pc.pkl')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_train1_test1_pc2pc.csv')
...
f1 = metrics.f1_score(y_true=y_test_non_pc, y_pred=preds)
print("F1 score is: ", f1)

precision = metrics.precision_score(y_true=y_test_non_pc, y_pred=preds)
print("Preicision score is: ", precision)

recall = metrics.recall_score(y_true=y_test_non_pc, y_pred=preds)
print("Recall score is: ", recall)

print(metrics.classification_report(y_true=y_test_non_pc, y_pred=preds))
print(metrics.confusion_matrix(y_true=y_test_non_pc, y_pred=preds))

tn, fp, fn, tp = metrics.confusion_matrix(y_true=y_test_non_pc, y_pred=preds).ravel()
specificity = tn / (tn + fp)
print("Specificity score is: ", specificity)
sensitivity = tp / (tp + fn)
print("Sensitivity score is: ", sensitivity)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_pc2nonpc_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_pc2nonpc_ROC_curve.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_train1_test1_pc2nonpc.pkl')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_train1_test1_pc2nonpc.csv')
print('metrics file saved')
print()
...
# print("F1 score is: ", metrics.f1_score(y_true=y_test_non_pc, y_pred=preds))
# print("Preicision score is: ", metrics.precision_score(y_true=y_test_non_pc, y_pred=preds))
# print("Recall score is: ", metrics.recall_score(y_true=y_test_non_pc, y_pred=preds))
# print(metrics.classification_report(y_true=y_test_non_pc, y_pred=preds))
# print(metrics.confusion_matrix(y_true=y_test_non_pc, y_pred=preds))
# tn, fp, fn, tp = metrics.confusion_matrix(y_true=y_test_non_pc, y_pred=preds).ravel()
# specificity = tn / (tn + fp)
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_nonpc2pc_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_nonpc2pc_ROC_curve.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_train1_test1_nonpc2pc.pkl')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_train1_test1_nonpc2pc.csv')
print('metrics file saved')
print()
...
# plt.title('Precision-Recall Curve')
plt.legend(loc="lower left")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_nonpc2nonpc_prec_recall_curve.png')
print()
print()
...
# plt.title('Receiver Operating Characteristic')
plt.legend(loc="lower right")
plt.savefig('logs_MH_subset/figures/RF_train1_test1_nonpc2nonpc_ROC_curve.png')
print('saved roc-auc curve')
print()

# save test on PC model
# clf.save_model('logs_MH_subset/saved_models/xgboost_entire_data_testPC.json')
joblib.dump(clf, 'logs_MH_subset/saved_models/RF_train1_test1_nonpc2nonpc.pkl')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/RF_train1_test1_nonpc2nonpc.csv')
print('metrics file saved')
print()
