...
for k in range(0, len(our_problem_keys_names)):
    try:
        ...
        print('Not in MH 94 features:', mhrn_problem_key_names[k])

print()
print('-----------------')
print()

for kk in range(0, len(mhrn_problem_key_names)):
    try:
        kl = mhrn_problem_key_names[kk]
        del joined_dict[kl]
    except Exception:
        del joined_dict[our_problem_keys_names[kk]]
        print('Not in MH 94 features:', mhrn_problem_key_names[kk])
...
mhrn_dict_csv_file = 'mhrn_dict_NEW2_MH.csv'
our_dict_csv_file = 'our_dict_NEW2_MH.csv'
joined_dict_csv_file = 'joined_dict_NEW2_MH.csv'
