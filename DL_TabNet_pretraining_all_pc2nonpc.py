...
# drop cols not overlapping with mhrn protocol
...
# drop empty cols to replace and correct
...
print('Training TabNet, optimizing with Optuna, weights=1, Train PC, Test Non PC')
print()
...
# ### Wegiths 1
print()
print('Training TabNet, with optimized Optuna params, weights=1, Train PC, Test Non PC')
print()
...
print('Results TabNet, with optimized Optuna params, weights=1, Train PC, Test Non PC')
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_train1_test1_pc2nonpc_prec_recall_curve_over13.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_train1_test1_pc2nonpc_ROC_curve_over13.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_pre2_train1_test1_pc2nonpc_over13')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_pre2_train1_test1_pc2nonpc_over13.csv')
...
# # ### Weights 0
#
# print('Training TabNet, with optimized Optuna params, weights=0, Train PC, Test Non PC')
# print("weights=0")
# print()
#
#
...
# print()
#
# print('Results TabNet, with optimized Optuna params, weights=0, Train PC, Test Non PC')
# acc_val = accuracy_score(y_val_non_pc, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val_non_pc.values)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val_non_pc)
