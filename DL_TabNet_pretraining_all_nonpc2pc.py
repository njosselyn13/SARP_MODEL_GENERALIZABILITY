...
print()
print('----------------------------------------')
print("PRE-TRAINING EXPERIMENTS")
print('----------------------------------------')
print()
...
# drop cols not overlap with MHRN protocol
...
print('Training TabNet, optimizing with Optuna, weights=1, Train Non PC, Test PC')
print()
...
def objective_pretrain(trial):
    ...
    unsupervised_model.fit(
        X_train=X_train_pretrain.values,
...
# ### Wegiths 1
print()
print('Training TabNet, with optimized Optuna params, weights=1, Train Non PC, Test PC')
print()
...
print('Results TabNet, with optimized Optuna params, weights=1, Train Non PC, Test PC')
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_run2_train1_test1_nonpc2pc_prec_recall_curve.png')
print()
print()
...
plt.savefig('logs_MH_subset/figures/TabNet_pre2_run2_train1_test1_nonpc2pc_ROC_curve.png')
...
clf.save_model('logs_MH_subset/saved_models/TabNet_pre2_run2_train1_test1_nonpc2pc')
print("model saved")
print()
...
df_pc.to_csv('logs_MH_subset/saved_csvs/TabNet_pre2_run2_train1_test1_nonpc2pc.csv')
...
# # ### Weights 0
#
# print('Training TabNet, with optimized Optuna params, weights=0, Train Non PC, Test PC')
# print("weights=0")
# print()
#
#
...
# print()
#
# print('Results TabNet, with optimized Optuna params, weights=0, Train Non PC, Test PC')
# acc_val = accuracy_score(y_val, preds_val) * 100
# print("Validation Accuracy for Optuna Tuned Model: ", acc_val)
# preds_val= clf.predict_proba(X_val.values)
# val_auc = roc_auc_score(y_score=preds_val[:,1], y_true=y_val)
